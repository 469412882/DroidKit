...
import com.yofish.kitmodule.permission.PermissionNo;
import com.yofish.kitmodule.permission.PermissionYes;
 ...
 */
public class PermissionAnnotationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int setLayoutId(Bundle savedInstanceState) {
        return R.layout.activity_permission_annotation;
    }
                ...
                AndPermission.with(this)
                        ...
                        .rationale(new RationaleListener() {
                            ...
                            public void showRequestPermissionRationale(int requestCode, Rationale rationale) {
                                ...
                                AndPermission.rationaleDialog(PermissionAnnotationActivity.this, rationale).show();
                            }
                        })
                        .start();
                break;
