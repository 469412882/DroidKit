package com.yofish.kitmodule.wedget.slidingtab;
...
import com.yofish.kitmodule.wedget.slidingtab.navigator.PositionData;
...
public class FragmentContainerHelper {
    private List<PagerSlidingIndicator> mMagicIndicators = new ArrayList<PagerSlidingIndicator>();
    ...
    public FragmentContainerHelper(PagerSlidingIndicator magicIndicator) {
    ...
    public void attachMagicIndicator(PagerSlidingIndicator magicIndicator) {
        mMagicIndicators.add(magicIndicator);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (PagerSlidingIndicator magicIndicator : mMagicIndicators) {
