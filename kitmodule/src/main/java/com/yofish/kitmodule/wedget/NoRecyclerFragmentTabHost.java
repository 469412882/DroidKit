...
public class NoRecyclerFragmentTabHost extends TabHost implements
    ...
    public NoRecyclerFragmentTabHost(Context context) {
    ...
    public NoRecyclerFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
